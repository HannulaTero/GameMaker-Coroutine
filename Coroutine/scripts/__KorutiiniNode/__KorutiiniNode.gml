...
* @returns {Struct}
*/ 
function __KorutiiniNode_NODE(_name)
{ 
  gml_pragma("forceinline"); 
  return { name: _name }; 
}
...
* @returns {Struct}
*/
function __KorutiiniNode_FINISH()
{ 
  gml_pragma("forceinline"); 
  return { name: "FINISH" }; 
}
...
* @returns {Struct}
*/
function __KorutiiniNode_BLOCK(_nodes)
{ 
  gml_pragma("forceinline"); 
  return {
    name: "BLOCK", 
...
* @returns {Struct}
*/
function __KorutiiniNode_STMT(_call)
{ 
  gml_pragma("forceinline"); 
  return {
    name: "STMT", 
...
* @returns {Struct}
*/
function __KorutiiniNode_LABEL(_label)
{ 
  gml_pragma("forceinline"); 
  return {
    name: "LABEL", 
...
* @returns {Struct}
*/
function __KorutiiniNode_YIELD()
{ 
  gml_pragma("forceinline"); 
  return { name: "YIELD" };
}
...
* @returns {Struct}
*/
function __KorutiiniNode_PAUSE()
{ 
  gml_pragma("forceinline"); 
  return { name: "PAUSE" };
}
...
* @returns {Struct}
*/
function __KorutiiniNode_SET(_call)
{ 
  gml_pragma("forceinline"); 
  return {
    name: "SET", 
...
* @returns {Struct}
*/
function __KorutiiniNode_AWAIT(_type, _call)
{ 
  gml_pragma("forceinline"); 
  return {
    name: $"AWAIT_{_type}", 
...
* @returns {Struct}
*/
function __KorutiiniNode_AWAIT_SUBTASKS()
{ 
  gml_pragma("forceinline"); 
...
* @returns {Struct}
*/
function __KorutiiniNode_AWAIT_REQUESTS()
{ 
  gml_pragma("forceinline"); 
...
* @returns {Struct}
*/
function __KorutiiniNode_AWAIT_LISTENERS()
{ 
  gml_pragma("forceinline"); 
...
* @returns {Struct}
*/
function __KorutiiniNode_IF_CHAIN()
{
  gml_pragma("forceinline"); 
  ...
  var _root = __KorutiiniNode_IF(argument[0], argument[1]);
  var _prev = _root;
  for(var i = 2; i < argument_count; i+=2)
  {
    var _cond = argument[i + 0];
    var _node = argument[i + 1];
    if (_cond == __KorutiiniNode_NOP)
    {
      _prev.nodeElse = _node;
      break;
    }
    var _next = __KorutiiniNode_IF(_cond, _node);
...
* @returns {Struct}
*/
function __KorutiiniNode_IF(_cond, _then, _else=undefined) 
{ 
  gml_pragma("forceinline");   
  return {
    name: "IF", 
...
* @returns {Struct}
*/
function __KorutiiniNode_SWITCH()
{
  gml_pragma("forceinline"); 
...
* @returns {Struct}
*/
function __KorutiiniNode_LOOP(_body) 
{ 
  gml_pragma("forceinline"); 
  return {
    name: "LOOP", 
