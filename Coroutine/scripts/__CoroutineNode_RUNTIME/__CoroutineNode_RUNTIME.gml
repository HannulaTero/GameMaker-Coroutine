...
* @returns {Function}
*/
function __CoroutineNode_RUNTIME_RESTART()
{
...
* @returns {Function}
*/
function __CoroutineNode_RUNTIME_CONTINUE()
{
...
* @returns {Function}
*/
function __CoroutineNode_RUNTIME_BREAK()
{
...
*/
function __CoroutineNode_RUNTIME_RETURN(_return)
{
...
* feather ignore GM1049
*/
function __CoroutineNode_RUNTIME_CANCEL()
{
  COROUTINE_CURRENT_YIELDED = true;
  with(COROUTINE_CURRENT_TASK)
  {
...
* @returns {Function}
*/
function __CoroutineNode_RUNTIME_GOTO(_label)
{
  // feather ignore GM1049
  with(COROUTINE_CURRENT_TASK)
  {
