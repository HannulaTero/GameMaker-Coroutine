...
/**
* Creates iterable buffer view (data, dtype, start, stop, step)
* 
* The arguments are optional.
* You may give every parameter as struct.
* Alternatively give as arguments (order matters)
*/
function __KorutiiniView() constructor
{
  // Declare variables.
  data  = undefined;
  dtype = undefined;
