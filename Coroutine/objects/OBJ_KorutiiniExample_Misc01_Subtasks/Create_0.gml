...
KORUTIINI BEGIN
  ...
  // Launch subtasks.
  KORUTIINI BEGIN PRINT "subtask[0] begin" DELAY random_range(0.2, 5.0) SECONDS PRINT "subtask[0] end" FINISH DISPATCH
  KORUTIINI BEGIN PRINT "subtask[1] begin" DELAY random_range(0.2, 5.0) SECONDS PRINT "subtask[1] end" FINISH DISPATCH
